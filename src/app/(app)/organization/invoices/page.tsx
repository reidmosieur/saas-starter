...
export default async function Page() {
	...
	const invoices =
		hideStripeDependents || !stripeCustomerId
			? [
					{
						id: 'in_001',
	...
	return (
		<TabsContent value="invoices" className="space-y-6 py-4 md:py-6">
			{!stripeCustomerId ? (
				<Alert>
					<User className="h-4 w-4" />
					<AlertTitle>Heads up!</AlertTitle>
					<AlertDescription>
						There is no customer associated with this user. Some or all of the
						data displayed is mocked.
					</AlertDescription>
				</Alert>
			) : null}
