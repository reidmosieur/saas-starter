...
INSERT INTO "new_User" ("createdAt", "email", "firstName", "id", "lastName", "passwordId", "phoneNumberId", "updatedAt", "username") SELECT "createdAt", "email", "firstName", "id", "lastName", "passwordId", "phoneNumberId", "updatedAt", "username" FROM "User";
DROP TABLE "User";
